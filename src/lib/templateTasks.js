...
export const TEMPLATE_TASKS = [
  ...
  // ── Funnel ──
  { sectionName: 'Funnel', title: 'Build funnel according to strategy', role: 'GoHighLevel Specialist' },
  { sectionName: 'Funnel', title: 'Client Assets', role: 'Project Manager' },
  { sectionName: 'Funnel', title: 'Purchase Lookalike Domain', role: 'Project Manager' },
  { sectionName: 'Funnel', title: 'Client Offer', role: 'Project Manager' },
  { sectionName: 'Funnel', title: 'Tracking code installation', role: 'GoHighLevel Specialist' },

  // ── Workflow Automation ──
  { sectionName: 'Workflow Automation', title: 'CAPI Conversion', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Google Number Pool Conversion', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'New Lead Optin - Did not schedule', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Booked Appointment Reminder', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'No Show/Cancelled Appointment Win-back', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Pipeline Changed To No Show/Cancelled', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Lead to AI Outbound Call', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Get and Place Call: Outbound + Inbound', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Reactivation Call: Stale Customer', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Lead Type Updater & Aging', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Inbound Message Internal Notification', role: 'GoHighLevel Specialist' },
  { sectionName: 'Workflow Automation', title: 'Missed Call Text Back', role: 'GoHighLevel Specialist' },

  // ── Tracking/Setup (GHL) ──
  { sectionName: 'Tracking/Setup', title: 'Integration', role: 'Project Manager' },
  { sectionName: 'Tracking/Setup', title: 'Integration (Meta)', role: 'GoHighLevel Specialist' },
  { sectionName: 'Tracking/Setup', title: 'Integrate Domain', role: 'GoHighLevel Specialist' },
  { sectionName: 'Tracking/Setup', title: 'Set and Validate Dedicated Sending Domain', role: 'GoHighLevel Specialist' },
  { sectionName: 'Tracking/Setup', title: 'A2P Application', role: 'Project Manager' },
  { sectionName: 'Tracking/Setup', title: 'Google Lead Event Creation', role: 'Google Specialist' },
