...
import { runInitialMigrationAndSeed, createNewClientWithTemplate, runPatchV1, runResetToUserTasks, runPatchV4, runPatchV5, runPatchV6, runPatchV7, runPatchV8, runPatchV9, runPatchV10, runPatchV11, runPatchV12, runPatchV13, runPatchV14, runPatchV15, runPatchV16, runPatchV17, runPatchV18 } from '../lib/migration'
  ...
  useEffect(() => {
    const fetchStaticData = async () => {
      ...
      try {
        ...
        await runPatchV13(user.uid)
        await runPatchV14(user.uid)
        await runPatchV15(user.uid)
        await runPatchV16(user.uid)
